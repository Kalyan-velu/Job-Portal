  ...
  <>
    <header className={' sticky top-0 z-50'}>
      ...
      <span>
        ...
        <div className="flex items-center border border-gray-200 drop-shadow rounded-full px-8 py-2">
    ...
    <section className={'flex flex-col items-center justify-center gap-4 py-32'}>
      <h1 className={'text-center font-bold text-5xl'}>Find Your Dream Job. Faster.</h1>
      <p className={'text-center max-w-xl text-xl mt-6 text-black/80 dark:text-foreground/80'}>The smarter way to connect with companies that actually want you.
