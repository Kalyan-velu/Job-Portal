import type { JobInterface } from '@server/types'
import { jobTypeList } from '@server/zod/job.schema'
import { model, Schema, type Document, type ObjectId } from 'mongoose'

interface JobDocument extends Omit<JobInterface,'company'|'postedBy'>,Document{
